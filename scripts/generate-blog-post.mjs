...
/**
 * İDDİA KAPISININ ÇEKİRDEĞİ BURADA DEĞİL, scripts/lib/claim-gate.mjs'DE.
 * Sebep: ürün açıklamaları da (scripts/generate-product-blurbs.mjs) aynı
 * yasak-iddia / uydurma-kanıt / doz / bileşen kurallarına tabi. Kuralları
 * kopyalamak, birinde düzeltilen yanlış pozitifin diğerinde yaşamaya devam
 * etmesi demekti. Aşağıda kalan kurallar MAKALEYE ÖZGÜ olanlardır
 * (uzunluk eşikleri, answer-first, bölüm/SSS yapısı).
 */
import {
  p,
  readJson,
...
// ---------------------------------------------------------------------------
// KALİTE KAPISI — MAKALEYE ÖZGÜ KATMAN
//
// İddia taramaları (marka, yasak sağlık beyanı, uydurma kanıt, doz, karışım
// bileşeni) lib/claim-gate.mjs'den geliyor ve ürün açıklamalarıyla ORTAK.
// Burada yalnızca makale biçimine ait kurallar var.
// ---------------------------------------------------------------------------
